              ...
              <>
                ...
                {phase !== "decision" && latestFinding ? (
                  <div
                    ...
                    className="pointer-events-none absolute left-3 right-3 top-[18.5rem] z-20 rounded-xl border border-teal-200/30 bg-[#082129]/[0.95] px-4 py-3 shadow-2xl backdrop-blur-md sm:bottom-20 sm:left-auto sm:right-5 sm:top-auto sm:w-[360px]"
                  >
                    <button
                      type="button"
                ...
                {phase === "decision" ? (
                  <div className="absolute left-3 right-3 top-[18.5rem] z-20 rounded-xl border border-white/15 bg-[#071a20]/[0.94] p-3 shadow-2xl backdrop-blur-md sm:left-auto sm:right-5 sm:top-5 sm:w-[390px] sm:p-4" data-testid="imaging-decisions">
