...
export default function FocusedAnkleLab() {
  ...
  const decisionFeedback = decision ? getDecisionFeedback(examCase, decision) : null;
        ...
        >
          ...
          >
            ...
            {started && !decision ? (
              <>
                <div
                  ...
                  className="pointer-events-none absolute left-3 top-3 z-20 w-[min(350px,calc(100%-1.5rem))] rounded-xl border border-white/15 bg-[#071a20]/[0.93] p-3.5 shadow-2xl backdrop-blur-md sm:left-5 sm:top-5 sm:p-4"
                >
                  ...
                  <p className="mt-1.5 text-xs leading-4 text-slate-300 sm:leading-5">
                ...
                {phase !== "decision" && latestFinding ? (
                  <div
                    ...
                    className="pointer-events-none absolute bottom-20 left-3 right-3 z-20 rounded-xl border border-teal-200/30 bg-[#082129]/[0.95] px-4 py-3 shadow-2xl backdrop-blur-md sm:left-auto sm:right-5 sm:w-[360px]"
                  >
                    <button
                      type="button"
                    ...
                    <p className="mt-1 pr-6 text-[11px] leading-4 text-slate-200">{examTechniques[latestFinding]}</p>
                ...
                {phase === "decision" ? (
                  <div className="absolute bottom-20 left-3 right-3 z-20 rounded-xl border border-white/15 bg-[#071a20]/[0.94] p-3 shadow-2xl backdrop-blur-md sm:bottom-auto sm:left-auto sm:right-5 sm:top-5 sm:w-[390px] sm:p-4" data-testid="imaging-decisions">
            ...
            {!started ? (
              ...
              >
                <Stethoscope size={17} /> Begin guided exam
                <ArrowRight size={16} />
              </button>
            ) : null}
          </section>
                ...
                <div data-testid="exam-debrief">
                  ...
                  <div className="mt-5 grid grid-cols-2 gap-2">
                    <div className="rounded-md border border-white/10 bg-white/[0.035] p-3">
                      ...
                      <p className="mt-1 text-lg font-black text-white">{score.assessmentPercent} / 70</p>
                    </div>
                    <div className="rounded-md border border-white/10 bg-white/[0.035] p-3">
                    ...
                    <div className="mt-2 space-y-2">
                      {examCase.decisionDrivers.map((id) => (
                        <div key={id} className="rounded-md border border-white/10 bg-white/[0.025] px-3 py-2.5">
                          <p className="text-xs font-bold text-white">{findingLabels[id]}</p>
