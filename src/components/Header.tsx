      ...
      <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-3 py-3">
        ...
        <div className="flex items-center gap-2 text-sm text-slate-700">
          ...
          <button
            ...
            className="grid h-11 w-11 place-items-center rounded-md border border-[#b7ccc5] bg-white text-slate-800 shadow-sm transition hover:border-teal-500 hover:bg-teal-50 md:hidden"
          >
            ...
            <Link
              ...
              className={`flex min-h-11 items-center rounded-md border px-3 py-2.5 text-sm font-semibold shadow-sm transition ${
                isCurrentPage(item.href)
                  ...
                  : "border-[#c8dcd6] bg-white/80 text-slate-700 hover:border-teal-400 hover:bg-teal-50"
              }`}
            >
              {item.label}
            </Link>
